        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          ...
          <div className="text-center mb-0 sm:mb-0 md:mb-3 lg:mb-5 sm:mt-5 lg:mt-3 mt-5">
            <div className="text-center inline-block sm:text-xl lg:text-xl text-white tracking-tight sm:text-lg sm:mt-3 lg:mt-5">
              I'll build and deploy a slick, blazingly-fast, mobile-friendly
              website with various features, easy management system and customer
              support. All at an affordable (and negotiable) pricing.
            </div>
          </div>
          <center>
            <Link
