          ...
          <div class="space-y-4">
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                ...
                pictures, we&apos;re happy to do that for you anytime, for all
                tier levels. Standard tier does come with regular monthly
                updates (maintenance), where we update whatever&apos;s been
                requested. If you are looking to run a website that needs
                constant updates with new content (ex: blog), we could discuss
                an alternate plan where you pay subscription-based monthly fees
                (instead of one-time payment), for us to regularly update it all
                the time.
              </p>
            </details>
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
            ...
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                ...
                website, we will hook it up for you. This process requires
                making DNS records (don&apos;t worry if you are unfamiliar) and
                connecting the webserver to the DNS. This is done on your
                domain&apos;s registrar, on the DNS panel. Assuming that you do
                not want me to directly access the registrar (with your
                credentials), we could hop on a 10-min phone call and we&apos;ll
                instruct you on what to do. Please note that the domain name
                must be registered under your name, hence the reason why
                it&apos;s a separate purchase from our service. If you
            ...
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                Bian: I&apos;m currently a college student double majoring in
                computer science and economics. I&apos;ve built countless many
                websites, both static and dynamic, using various technologies
                and stacks:
                <a
            ...
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                Bian: First, I am trying to raise capital that I can allocate
                towards my startup. Since VCs are out of reach as of now, this
                is one of the &quot;hustles&quot; I do to make money. Second, I
                constantly improve my dev skills simply from writing lots of
                code and completing many projects. This work isn&apos;t just
            ...
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                We ask that all our clients pay 20% upfront. Once the work is
            ...
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                ...
                code will be written later on, we aim to provide strong
                foundations of an app that utilizes various software techniques
                such as dynamic components, server-side rendering,
                code-splitting, etc. The goal is for clients (founders) to focus
                on core features of their business, while leaving us to build
                the bare-bones. At request, additional features could be
                implemented: This includes but not limit to Firebase
                authentication, database integration with MongoDB, simple CMS
                using Google Sheets API, A/B testing, Google analytics, etc. We
                also work more closely with the founder(s) to build a strong
                brand.
              </p>
            </details>
            <details class="group rounded-lg bg-gray-200 p-6 [&_summary::-webkit-details-marker]:hidden">
              ...
              <p class="mt-4 leading-relaxed text-gray-700">
                Bian: Yes, absolutely. I actively follow the startup space and
                would love to join one as a SWE. My internship at Vestr.io, a
                social finance startup, has given me some insight into the
                process of series funding, team-building, and rolling out
                products. I&apos;m quite interested in customer acquisition, as
                well as raising capital. If you are a startup founder in need of
                an engineer, you should consider hiring me.
              </p>
            </details>
          </div>
        </div>
